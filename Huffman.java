...
public class Huffman {
  ...
  public static void main(String[] args) {
    ...
    if ((args.length != 2)) {
      System.out.println("Usage: java input output");
      System.exit(1);
    }
    ...
    // Write the Huffman Key to the output file Write the compressed data to the output file
  ...
  //Read input file & Write compressed data to output file
